                    ...
                    <div className='flex items-center justify-center gap-3'>
                        {
                            [
                                ...
                                {
                                    icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100"
